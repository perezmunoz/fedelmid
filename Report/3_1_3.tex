...
\begin{itemize}
	...
	\item Adding an unique \textbf{Player ID} at each table constructed as follows: /playes/b/bryanko01.html becomes bbryanko01. Each player then can be accessed with its unique key
...
\paragraph()Scraping these web pages had been tricky in which the code should catch all these specialties. For further information about the code providing the player's statistics scraper, see the player_statistics_BS.py file.
