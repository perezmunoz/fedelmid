...
\paragraph{}The output \verb|totals_final.csv| and \verb|per_game_final.csv| tables can be find in \ur{Data/Part1/} folder.
...
\paragraph{}The output \verb|salaries_final.csv| table can be find in \ur{Data/Part1/} folder.
